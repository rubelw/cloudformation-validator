...
def lineno():
    ...
    return str(' -  RdsHasTagsRule - caller: ' + str(inspect.stack()[1][3]) + ' - line number: ' + str(
        inspect.currentframe().f_back.f_lineno))


class RdsCustomTagsRule(BaseRule):
    """
    Rds custom tags rule
    """
    ...
    def audit_impl(self):
        ...
        """
        if self.debug:
            print('RdsHasTagsRule - audit_impl' + lineno())
