...
class TestEbsInstance(unittest.TestCase):
    """
    Test ec2 instance
    """
    ...
    def test_ebs_volume_no_tags(self):
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/cloudformation_validator/test_templates/json/rds_instance/no_tags.json'
      debug = False
    ...
    def test_rds_instance_has_required_tags(self):
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/cloudformation_validator/test_templates/json/rds_instance/has_required_tags.json'
      debug = False
    ...
    def test_rds_instance_missing_one_required_tag(self):
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/cloudformation_validator/test_templates/json/rds_instance/missing_one_required_tags.json'
      debug = False
