...
class TestIamUser(unittest.TestCase):
    ...
    def test_iam_user_has_no_group_membership(self):
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/cloudformation_validator/test_templates/json/iam_user/iam_user_with_no_group.json'
      debug = False
