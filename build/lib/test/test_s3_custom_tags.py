...
class TestS3(unittest.TestCase):
    ...
    def test_s3_no_tags(self):
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/cloudformation_validator/test_templates/json/s3_bucket/no_tags.json'
      debug = False
    ...
    def test_s3_has_required_tags(self):
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/cloudformation_validator/test_templates/json/s3_bucket/has_required_tags.json'
      debug = False
    ...
    def test_s3_missing_tags(self):
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/cloudformation_validator/test_templates/json/s3_bucket/missing_one_required_tags.json'
      debug = False
