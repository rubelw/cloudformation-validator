...
class TestEc2Instance(unittest.TestCase):
    ...
    def test_ec2_instance_authentication(self):
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/cloudformation_validator/test_templates/json/ec2_instance/cfn_authentication.json'
      debug = False
    ...
    def test_ec2_instance_insensitive_authentication(self):
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/cloudformation_validator/test_templates/json/ec2_instance/cfn_insensitive_authentication.json'
      debug = True
