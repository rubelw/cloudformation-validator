...
class TestLoadBalancer(unittest.TestCase):
    ...
    def test_two_loadbalancers_without_access_logging_enabled(self):
      ...
      template_name = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))+'/cloudformation_validator/test_templates/json/elasticloadbalancing_loadbalancer/two_load_balancers_with_no_logging.json'
      debug = False
